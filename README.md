...
$\text{\color{#BDEBC9}𐂯  ‎ ੭ৎ ͜ ‎}$ ‎ ‎  $\text{\color{#CCDD99} ♬}$　　　 ![Github Views](https://views.igorkowalczyk.dev/api/badge/clownzyj?label=pride+duo+♡&labelColor=BDEBC9&color=B78FC7)

$\text{\color{#DD98A5} go}$　 $\text{\color{#B78FC7} sign}$　 $\text{\color{#ACC8D5} my}$  　[ata](https://c-utesy.atabook.org) 　　  $\text{\color{#BDEBC9}‎ㆍωㆍ}$　  $\text{\color{#DFA6DF}.ᐟ}$
